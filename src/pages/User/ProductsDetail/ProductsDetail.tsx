  ...
  return (
    <div>
      <Container>
        ...
        <div>
          <Row>
            <Col span={10}>
              <Dv2>
                <div>
                  <img src={products?.image} width="250px" />
                </div>
                <div>
                  <Row>
                    <Col span={4}>
                ...
                <Row>
                  <Col span={8}>
                    <Title level={2} type="danger">
                     {formatCash(products?.originalPrice)}đ
                    </Title>
                  </Col>
                  <Col span={4}>
                    <Text>{formatCash(products?.saleOffPrice)}đ</Text>
                  </Col>
                </Row>
              </div>
              <div>
        ...
        <div>
          <Section>
            <h2 style={{marginTop:"20px"}}>Sản phẩm liên quan</h2>
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              {productsByCate.map((item: any) => {
                if(item.status == "hiện" && item.id != products.id)
                return (
                ...
                <Link to={"/products/"+item.id}>
                  ...
                  >
                    ...
                    <Row>
                      <Col span={12}>
                        <Text type="danger">{formatCash(item.originalPrice)}</Text>
                      </Col>
                      <Col span={12}>
                        <Text type="secondary">{formatCash(item.saleOffPrice)}</Text>
                      </Col>
                    </Row>
                    <Borders>
                      <Text>
